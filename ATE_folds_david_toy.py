...
X, T, prob = create_data_generate_process(mode='toy_example_folds_step1')
...
for x_i_outcome_effect_weight in x_i_outcome_effect_weights:
    ...
    Y, Y1, Y0 = create_data_generate_process(mode='toy_example_folds_step2', X=X, T=T, x_i_outcome_effect_weight=x_i_outcome_effect_weight)
